classdef Camera < handle
    ...
    methods
        function [self] = Camera(varargin)
            ...
            p.KeepUnmatched = true;
                addParameter(p,'CameraModel',PinholeModel(),validCameraModel);
    ...
    methods (Access = public)       
        ...
        function [rays] = PixelsToRays(self,pixels)   
